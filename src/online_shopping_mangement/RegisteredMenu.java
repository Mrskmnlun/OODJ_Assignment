...
public class RegisteredMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Electronic Accessories", "Health & Beauty", "Home & Lifestyle", "Fashion" }));
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        if(jComboBox1.getSelectedItem().equals("Electronic Accessories"))
        {
            jComboBox2.removeAllItems();
            jComboBox2.setSelectedItem(null);
            jComboBox2.addItem("mobile");
            jComboBox2.addItem("computer");
            jComboBox2.addItem("tv");
            jComboBox2.addItem("camera");
        }
        else
        if(jComboBox1.getSelectedItem().equals("Health & Beauty"))
        {
            jComboBox2.removeAllItems();
            jComboBox2.setSelectedItem(null);
            jComboBox2.addItem("skincare");
            jComboBox2.addItem("hair");
            jComboBox2.addItem("bath");
            jComboBox2.addItem("medical");
        }
        else
        if(jComboBox1.getSelectedItem().equals("Home & Lifestyle"))
        {
            jComboBox2.removeAllItems();
            jComboBox2.setSelectedItem(null);
            jComboBox2.addItem("decor");
            jComboBox2.addItem("funiture");
            jComboBox2.addItem("kitchen");
            jComboBox2.addItem("outdoor");
        }
        else
        if(jComboBox1.getSelectedItem().equals("Fashion"))
        {
            jComboBox2.removeAllItems();
            jComboBox2.setSelectedItem(null);
            jComboBox2.addItem("women");
            jComboBox2.addItem("men");
            jComboBox2.addItem("accessories");
            jComboBox2.addItem("sport");
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        CustomerMainPage at = new CustomerMainPage();
        at.show();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisteredMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegisteredMenu().setVisible(true);
            }
        });
    }
