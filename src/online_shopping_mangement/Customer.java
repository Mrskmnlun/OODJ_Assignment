...
public class Customer extends User{
    ...
    public Customer(String username, String password, String sex, String address, String email, String phoneNumber) {
    ...
    public static boolean writeToFile(Customer customer,String role) {
        try {
            ...
            writer.write(customer.getUsername() + "/" + customer.getPassword() + "/" + customer.getSex() + "/" + customer.getAddress() + "/" + customer.getEmail() + "/" + customer.getPhoneNumber() + "/" + role+ "\n");
            writer.close();
            return true;
        } catch (IOException e) {
            e.printStackTrace();
...
public static Customer getUserData(String username) {
    ...
    public Customer(String username, String password, String sex, String address, String email, String phoneNumber, List<String> purchaseHistory) {
        this.username = username;
        this.password = password;
        this.sex = sex;
        this.address = address;
