...
public class AdminLogin extends javax.swing.JFrame {
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        try{
            ...
            if (ad.isValidLogin(Username, Password)){
                AdminOrStaff ad1 = new AdminOrStaff();
                ad1 = ad1.getUserData(Username);
                if (Usertype.equals(ad1.getUsertype())){
                    ...
                    if (Usertype.equals("Admin")){
                        ...
                        DeliveryMainPage am = new DeliveryMainPage(ad1.getUsername());
                        am.setVisible(true);
                        dispose();
                    }
                }
            ...
            JOptionPane.showMessageDialog(rootPane, "Please select the user type.", "System Error", JOptionPane.ERROR_MESSAGE);
        }
